...
function SofaIcon({width = 60, height = 60, lightShade = colors.themeBlue, darkShade = colors.darkBlue}) {
  return (
    <Svg width={width} height={height} viewBox="0 0 390.672 390.672">
      <G>
        <Path
        fill={lightShade}
          d="M83.934,195.093l0.004,0.285l0.008,17.451h222.781l0.012-17.709c0.559-20.158,13.303-36.898,31.126-43.34
        ...
        <Path
        fill={darkShade}
          d="M354.19,161.489c-19.806,0-35.911,15.783-36.456,35.457l-0.014,28.432H72.95l-0.013-28.432
